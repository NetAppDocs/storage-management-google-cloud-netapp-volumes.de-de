...
[role="quick-margin-para"]
Klicken Sie in der NetApp Konsole auf *System hinzufügen*, dann auf *Google Cloud Platform*, dann auf * Google Cloud NetApp Volumes* und dann auf *Erkennen*.  Geben Sie die Details zum Dienstkonto und zum Google Cloud-Projekt an.
